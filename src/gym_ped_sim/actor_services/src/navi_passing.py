...
startingPosition = {0:(-3,-0.5), 1:(-2.5,0.5), 2:(3, -0.5), 3:(2.5,0.5), 4:(4.5,0.5), 5:(3.5,0.5)}
targetPosition = {0: (2.5,-0.5), 1:(3,0.5),  2:(-2.5, -0.5), 3:(-3,0.5), 4:(-4.5,0.5), 5:(3.5,-0.5)}
speedOfActor = {0:1.2,1:0.9,2:1.1,3:1.2,4:1.1,5:1.3}
#for item in range(4):
...
tree_.write(actor_pkg_path+'/worlds/test_world_with_pedestrians_colored_ground.world', pretty_print=True, xml_declaration=True, encoding="utf-8")
